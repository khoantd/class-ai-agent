...
Supporting prompts: `debug`, `simplify`, `fix-issue` in `.kiro/commands/`.

## Mandatory standards

- Follow **`.kiro/steering/`** (`*.md` with YAML frontmatter). **`security.md`** and **`codegraph.md`** use `inclusion: always`; others often use `fileMatch`.
