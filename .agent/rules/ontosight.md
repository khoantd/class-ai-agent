...
| Visual exploration of a subgraph | `royalsolution-ontosight` |
...
royalsolution-ontosight "/absolute/path/to/workspace" \
...
royalsolution-ontosight "<workspace-root>" --symbol <name> --path <dir>
royalsolution-ontosight "<workspace-root>" --task "auth flow" --hops 2 --max-nodes 200
royalsolution-ontosight "<workspace-root>" --symbol <name> --path <dir> --hops 3 --max-nodes 200
```
